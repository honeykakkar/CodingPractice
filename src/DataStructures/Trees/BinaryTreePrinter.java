...
public class BinaryTreePrinter {
    ...
    static {
        ...
        trashable.add(BinaryTreePrinter.SIDE_WAYS_PLACEHOLDER);
        trashable.add(BinaryTreePrinter.SPACE_PLACEHOLDER);
    }



    //nodePrintLength is the size given to each node to print
    public static char[][] getCharArray(BinaryTreeNode head, int nodePrintLength) {
    ...
    //nodePrintLength is the size given to each node to print
    public static char[][] getCharArray(BinaryTreeNode head, int treeHeight, int nodePrintLength) {
    ...
    //nodePrintLength is the size given to each node to print
    public static String getString(BinaryTreeNode head, int nodePrintLength) {
        return getString(head, getHeight(head), nodePrintLength);
    }

    //returns printout of tring treeHeight levels deep
    //nodePrintLength is the size given to each node to print
    public static String getString(BinaryTreeNode head, int treeHeight, int nodePrintLength) {
        // get printout
    ...
    private static void printToArray(char[][]screen, BinaryTreeNode node,int height,Coord pos, int dataLength) {
        if(node == null) return;
    ...
    private static int getHeight(BinaryTreeNode theGuy) {
