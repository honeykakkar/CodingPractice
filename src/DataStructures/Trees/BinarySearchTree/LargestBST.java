...
// Credits for the code: Tushar Roy by Mission-peace
...
public class LargestBST {
    ...
    private int largestBST(BinaryTreeNode<Integer> root) {
        MinMax m = largest(root);
        return m.size;
    }

    private MinMax largest(BinaryTreeNode<Integer> root) {
    ...
    public static void main(String args[]) {
        LargestBST BSTFinder = new LargestBST();
        BinaryTree<Integer> BT = new BinaryTree<>();
        BT.insert(9, 15, 7, 6, 24, 21, 8, 3);
        BT.displayTree();
        int largestBSTSize = BSTFinder.largestBST(BT.getRoot());
