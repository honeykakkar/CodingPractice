...
public class CountInversions<T extends Comparable<T>> {
    ...
    private int mergeArrays(ArrayList<T> array, int start, int middle, int end){
    ...
    private int mergeSort(ArrayList<T> array, int start, int end) {
    ...
    public static void main(String[] args) {
        ...
        CountInversions<Integer> intSorter = new CountInversions<>();
        ArrayList<Integer> intArray = new ArrayList<>(n);

        intArray.add(1); intArray.add(20); intArray.add(6); intArray.add(4); intArray.add(5);
        ...
        System.out.println("Total inversions in the array: " + intSorter.mergeSort(intArray, 0, intArray.size()-1));
        ...
        CountInversions<Character> charSorter = new CountInversions<>();
        System.out.println("\nTesting characters in sorted order:");
       // System.out.println("Before performing merge sort:");
        charSorter.display(charArray);
        startTime = System.nanoTime();
        System.out.println("Total inversions in the array: " + charSorter.mergeSort(charArray, 0, charArray.size()-1));
        endTime = System.nanoTime();
        //System.out.println("After performing merge sort:");
       // charSorter.display(charArray);
        System.out.println("It took " + (endTime-startTime) + " ns to perform the sort.");
        ...
        CountInversions<Double> doubleSorter = new CountInversions<>();
        System.out.println("\nTesting doubles in random order:");
        //System.out.println("Before performing merge sort:");
        doubleSorter.display(doubleArray);
        startTime = System.nanoTime();
        System.out.println("Total inversions in the array: " + doubleSorter.mergeSort(doubleArray, 0, doubleArray.size()-1));
        endTime = System.nanoTime();
       // System.out.println("After performing merge sort:");
       // doubleSorter.display(doubleArray);
        System.out.println("It took " + (endTime-startTime) + " ns to perform the sort.");
